        ...
        <div className="bg-white p-12 shadow-sm">
          <div className="mb-10">
            ...
            <p className="text-base font-light leading-relaxed text-[#171719]">
              Let's create your account so you can start building that confident, amazing version of
              yourself. This is gonna be good.
            </p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-8">
            ...
            {success && (
              <div className="border-l-4 border-[#171719] bg-[#F1F1F1] p-6">
                <p className="text-sm font-light text-[#171719]">{success}</p>
              </div>
            )}
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs font-light text-[#B5B5B3]">At least 6 characters, please</p>
            </div>
            ...
            <div className="flex items-start space-x-4 py-2">
              <input
                ...
                className="mt-1 h-5 w-5 border-2 border-[#B5B5B3] checked:border-[#171719] checked:bg-[#171719] focus:outline-none"
              />
              <label
                htmlFor="emailMarketing"
                className="text-sm font-light leading-relaxed text-[#171719]"
              >
            ...
            <div className="flex items-start space-x-4 py-2">
              ...
              >
                ...
                <Link
                  href="/terms"
                  className="underline transition-colors duration-300 hover:text-[#B5B5B3]"
                >
                  Terms of Service
                </Link>{' '}
                and{' '}
