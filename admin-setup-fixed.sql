-- SELFIE AI™ Admin System Setup (FIXED - No RLS Recursion)
...
-- 3. Allow INSERT for new user creation (needed for the trigger)
...
-- Success message
SELECT 'SELFIE AI™ Admin System Setup Complete! (RLS Recursion Fixed)' as message;
