      ...
      <div className="bg-luxury-black text-soft-white p-10 mb-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="text-warm-gray">{animatedProgress}% Complete</span>
          </div>
          
          <div className="relative h-4 bg-soft-white/10 mb-5">
            <div 
              className="absolute left-0 top-0 h-full bg-soft-white transition-all duration-2000 ease-out" 
