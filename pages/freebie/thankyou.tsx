...
export default function ThankYouPage() {
  ...
  const getUserData = (): UserData => {
    ...
    return {
      email: (email as string) || (typeof window !== 'undefined' ? sessionStorage.getItem('userEmail') || '' : ''),
      name: (name as string) || (typeof window !== 'undefined' ? sessionStorage.getItem('userName') || '' : ''),
  ...
  return (
    <>
      <Head>
        ...
        <meta charSet="UTF-8" />
        <meta name="description" content="Your journey to selfie confidence starts here. Download your exclusive SELFIE AI™ guide and transform your selfie game." />
