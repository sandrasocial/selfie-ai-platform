...
export default function Home() {
  ...
  return (
    <>
      {/* Luxury Loader */}
      {isLoading && (
        <div className="fixed inset-0 z-50 bg-white flex items-center justify-center transition-opacity duration-1000" style={{ opacity: isLoading ? 1 : 0, pointerEvents: isLoading ? 'all' : 'none' }}>
          <div className="text-center">
            <div className="font-['Bordoni_FLF'] text-[48px] md:text-[64px] text-[#171719] opacity-0 animate-fadeInUp">
              SELFIE AI™
            </div>
            <div className="mt-8 w-24 h-px bg-[#171719]/20 mx-auto"></div>
          </div>
        </div>
      )}
      ...
      <div className="min-h-screen bg-white">
        ...
        >
          ...
          {/* Vignette effect */}
          <div className="absolute inset-0 bg-radial-gradient from-transparent via-transparent to-[#171719]/30"></div>
          ...
          <nav className="relative z-20 flex justify-between items-center px-8 md:px-16 lg:px-24 py-8">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex gap-12 lg:gap-16 items-center mr-12 lg:mr-16">
          ...
          <div className="relative z-10 flex items-center min-h-screen px-8 md:px-16 lg:px-24 pt-20 pb-24">
            <div className="max-w-7xl w-full mx-auto">
              ...
              <h1 className="relative">
                <span className="block font-['Bordoni_FLF'] text-[48px] md:text-[72px] lg:text-[96px] xl:text-[120px] leading-[1.1] text-white mb-2 opacity-0 animate-fadeInUp">
                  Your selfie
                </span>
                <span className="block font-['Bordoni_FLF'] italic font-light text-[48px] md:text-[72px] lg:text-[96px] xl:text-[120px] leading-[1.1] text-white ml-0 md:ml-16 lg:ml-24 mb-2 opacity-0 animate-fadeInUp animation-delay-200">
                  is your
                </span>
                <span className="block font-['Bordoni_FLF'] text-[48px] md:text-[72px] lg:text-[96px] xl:text-[120px] leading-[1.1] text-white text-right mr-0 md:mr-12 lg:mr-24 opacity-0 animate-fadeInUp animation-delay-400">
                  brand.
                </span>
              ...
              <div className="mt-16 md:mt-20 max-w-3xl mx-auto md:mx-0 md:ml-auto md:mr-32 opacity-0 animate-fadeInUp animation-delay-600">
              ...
              {/* CTAs - Ultra Refined */}
              <div className="mt-16 md:mt-20 flex flex-col md:flex-row gap-6 md:gap-8 justify-start md:justify-end md:mr-12 lg:mr-24">
                {/* Primary CTA - Editorial treatment */}
                <Link href="/dashboard">
                  <button className="group relative transform transition-all duration-300 hover:scale-[1.02]">
                    <div className="bg-transparent border border-white text-white px-10 md:px-12 py-4 md:py-5 overflow-hidden relative transition-all duration-500 hover:bg-white hover:text-[#171719]">
                ...
                <button className="group relative self-center transform transition-all duration-300 hover:scale-[1.02]">
