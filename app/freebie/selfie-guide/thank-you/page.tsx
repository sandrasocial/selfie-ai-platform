...
export default function ThankYouPage() {
  ...
  const [buttonText, setButtonText] = useState('GET GUIDE')
  ...
  const getUserData = () => {
    if (typeof window === 'undefined') return { email: '', name: '', templateId: TEMPLATE_ID }
  ...
  const triggerPDFGeneration = async () => {
    ...
    try {
      ...
      setStatusMessage('Ready to get your guide.')
  ...
  return (
    <div className="bg-[#F1F1F1] min-h-screen">
      {/* Font imports */}
      <link 
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,700;1,400;1,700&family=Inter:wght@100;200;300;400&display=swap" 
        rel="stylesheet" 
      />
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="w-full max-w-[1200px] mx-auto px-5 py-10">
          <div className="bg-white border border-[#B5B5B3] overflow-hidden relative">
            {/* Top Bar */}
            ...
            <div className="px-8 py-16 md:px-16 md:py-24 lg:px-20 lg:py-32 text-center">
              ...
              {/* Headline */}
              <h1 className="font-cormorant text-5xl md:text-6xl lg:text-7xl leading-tight font-light tracking-[-0.02em] mb-5 text-[#171719]">
                Welcome to Your
                <span className="font-cormorant italic block text-4xl md:text-5xl lg:text-6xl mt-3">
                  Selfie Journey
                </span>
              </h1>
              ...
              {/* Quote Section */}
              <div className="mb-16">
                <p className="font-cormorant text-3xl md:text-4xl leading-relaxed italic text-[#171719] mb-5">
            ...
            <div className="bg-[#F1F1F1] px-8 py-12 md:px-16 md:py-16 lg:px-20 lg:py-20 text-center">
              <h2 className="font-cormorant text-3xl md:text-3xl mb-4 font-light">
                Ready for More?
              </h2>
              <p className="text-base text-[#4C4B4B] mb-8 font-neue font-light">
                This guide is just the beginning. Join SELFIE AI™ and we'll help you show up like you mean it.
              </p>
              <a 
                href="/start-here" 
